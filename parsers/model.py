...
IR_VERSION = "1.2"  # 1.2: + ACLEntry.line. 1.1: + ACLEntry.src/dst_interfaces, Interface.zone/vdom, Device.vdom
...
class ACLEntry:
    ...
    line: Optional[int] = None  # source config line number (1-based) if known
